...
let users = {
  "data": [
      ...
      },
      {
          ...
          "allowedDays": null,
          "passwordHistory": "8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918;;",
...
class SignInScreen extends React.Component {
  ...
  static navigationOptions = {
   ...
   _signInAsync = async () => {
    ...
    // let index = users.data.findIndex(e => 
    //   e.email === this.state.username && e.password === this.state.password)
      
    //   if(index != -1){
    //     AsyncStorage.setItem('username', users.data[index].userName)
    //     AsyncStorage.setItem('id', users.data[index].id)
    //     this.props.navigation.navigate('Home');
    //   }else{
    //     showMessage('Datos incorrectos')
    //   }
